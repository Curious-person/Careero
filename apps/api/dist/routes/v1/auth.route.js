...
router.post('/check-email', validate_middleware_1.validateEmail, authController.checkEmail);
router.post('/request-otp', rateLimiter_1.otpLimiter, validate_middleware_1.validateEmail, authController.requestOtp);
